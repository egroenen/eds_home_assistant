...
history_content = (
    ...
    "| Date | Weather | Model est | Actual | Delta | Use | Net | Off-peak | Peak | Sold | SOC | Acc |\n"
    "|:--|:--|--:|--:|--:|--:|--:|--:|--:|--:|--:|--:|\n"
    "{% for d in days %}"
    "| {{ d.date[5:] }} "
    ...
    "{% endif %} |\n"
    "{% endfor %}\n\n"
    "<sub>Model est = optimiser adjusted/model solar kWh"
    "{% if days[0].raw_forecast_kwh is defined %} (raw Forecast.Solar is retained in JSON as raw_forecast_kwh){% endif %} · "
    "Actual = inverter production kWh · "
    "Delta = actual − model estimate · "
    "Net = production − consumption · "
    "Acc = actual/model estimate · "
